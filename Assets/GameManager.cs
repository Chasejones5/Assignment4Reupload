...
public class GameManager : MonoBehaviour
{
    ...
    private string[] wordsToGuess = { "whale", "shark", "octopus", "dolphin", "seal", "swordfish", "sea turtle", "squid", "jellyfish", "plankton" };
    ...
    Dictionary<string, string> funFacts = new Dictionary<string, string>
    {
        ...
        {"sea turtle", "Sea turtles can live for more than 100 years."},
